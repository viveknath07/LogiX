...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#1a1a1a]">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-6 py-3 px-4 bg-[#0067b8] text-white font-semibold rounded hover:bg-[#005da6] focus:outline-none focus:ring-2 focus:ring-[#0067b8] focus:ring-offset-2 focus:ring-offset-[#1a1a1a] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
          ...
          <div className="mt-8 flex items-center justify-between text-sm">
            <p className="text-gray-400">
              No account?{' '}
              <a href="/signup" className="text-[#0067b8] hover:text-[#005da6] hover:underline">
                Create one!
              </a>
            </p>
            <a href="#" className="text-[#0067b8] hover:text-[#005da6] hover:underline">
      ...
      <footer className="fixed bottom-0 w-full p-4 flex justify-between text-xs text-gray-400">
