...
export default function Dashboard() {
  ...
  const getStorageInfo = async () => {
    try {
      ...
      // For now using static values, later will be updated with actual storage calculations
      setStorageUsed(1.5) // 1.5 GB used
    } catch (error) {
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="flex h-[calc(100vh-3.5rem)]">
        <Sidebar 
          ...
          storageLimit={storageLimit / 1024 / 1024 / 1024} // Convert to GB
        />
              ...
              <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
                <div className="px-6 py-5">
                  ...
                  <FileList 
                    ...
                    onFileAction={() => setRefreshTrigger(prev => prev + 1)}
                  />
                </div>
              </div>
            </div>
