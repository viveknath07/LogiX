...
export default function Dashboard() {
  ...
  // File and folder management states
                      ...
                      <div className="w-full max-w-md">
                        <div className="relative pt-1">
                          ...
                          <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-blue-200 dark:bg-gray-700">
                            <div
                              className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-600 animate-pulse w-full"
                            ></div>
                          </div>
                        </div>
                      </div>
